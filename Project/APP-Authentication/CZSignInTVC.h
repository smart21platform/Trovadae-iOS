...
@interface CZSignInTVC : UITableViewController<CZAuthenticationDelegate, SHPUpdateUserCustomPropertiesDCDelegate, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate>{
...
@property (weak, nonatomic) IBOutlet UIImageView *imageTelephone;
