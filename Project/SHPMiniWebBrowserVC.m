...
-(void)viewDidAppear:(BOOL)animated {
    ...
    //NSString *trackerName = [[NSString alloc] initWithFormat:@"DetailPage: %@(%@) Class: %@", self.product.title, self.product.oid, NSStringFromClass([self class])];
    NSString *trackerName = [[NSString alloc] initWithFormat:@"WebPage: %@", self.urlPage];
