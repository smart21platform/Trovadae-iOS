...
- (NSArray *)jsonToUsers:(NSData *)jsonData {
    ...
    for(NSDictionary *item in items) {
        ...
        NSDictionary *numberPhoneDictionary = (NSDictionary *)[properties valueForKey:@"numberPhone"];
        NSString *numberPhone = nil;
        NSArray *valuesPhone = (NSArray *)[numberPhoneDictionary valueForKey:@"values"];
        if (valuesPhone.count > 0) {
            numberPhone = [valuesPhone objectAtIndex:0];
        }
        ...
        NSLog(@"******** productsCreatedByCount ***********: %@", user.productsCreatedByCount);
